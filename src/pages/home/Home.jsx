              ...
              <button
                ...
                className={
                  chatFriend == item._doc.userName2
                    ? "btn flex  hover:text-green-300 truncate justify-center md:w-[300px] p-1 px-1 rounded-2xl bg-blue-950 font-bold text-white "
                    : "btn flex justify-center truncate hover:text-green-300 md:w-[300px] p-1 px-2 rounded-2xl bg-blue-900 text-white "
                }
              >
                {item._doc.userName2}
                {item.count && (
